...
\newcommand{\subtopic}{eine ??? Webanwendung}
...
\newcommand{\company}{Freie Universität Berlin}
...
\include{kapitel/07projektstruktur}
\include{kapitel/08herausforderungen_lösungen}
\include{kapitel/09uml}
