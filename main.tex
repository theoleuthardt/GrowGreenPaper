...
\renewcommand\lstlistlistingname{Anhangverzeichnis}
...
\newcommand{\topic}{\textbf{Grow Green}}
...
\include{kapitel/01kurzbeschreibung}
\include{kapitel/02steckbrief}
\include{kapitel/03ziele}
\include{kapitel/04team_rollen}
\include{kapitel/05risikomanagement}
\include{kapitel/06aufwand}
\include{kapitel/07produktstruktur}
\include{kapitel/08herausforderungen_lösungen}
\include{kapitel/09uml_uc}
\include{kapitel/09uml_act}
\include{kapitel/10qualitätskriterien}
\include{kapitel/11technologien}
\include{kapitel/12anleitung}
